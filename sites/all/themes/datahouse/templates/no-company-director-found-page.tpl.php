...
?>
    <h1 class="visible-xs-block visible-lg-block visible-sm-block visible-md-block"><i class="fa fa-user"></i> <?php echo "No directors found of " . ucwords(strtolower($comp)); ?></h1>
