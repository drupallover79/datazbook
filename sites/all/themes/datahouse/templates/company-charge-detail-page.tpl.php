...
?>
    <h1 class="visible-xs-block visible-lg-block visible-sm-block visible-md-block"><i class="fa fa-money"></i> <?php echo "Charges on " . ucwords(strtolower($comp[0]->company_name)); ?></h1>
                ...
                <div class="box box-widget">
                    <div class="box-body no-padding">
                        <ul class="nav nav-stacked categories-menu">
                            ...
                            <li class="category-timeline active"><a href="<?php echo $charge_path; ?>"><i class="fa fa-money"></i> Charges</a></li>
                                        ...
                                        <div class="event-info-text">
                                            <div class="event-info-middle">
                                                <p><i class="fa fa-bank"></i> &nbsp;
                                                    <?php echo "<b>Charge Holder : </b>" . $dir->charge_holder; ?>
                                                </p>
                                                <p><i class="fa fa-calendar"></i> &nbsp;
                                                    <?php echo "<b>Charge Creation Date : </b>" . $dir->charge_creation_date 	; ?>
                                                </p>
                                                <p><i class="fa fa-money"> </i>
                                                    <?php echo "<b>Charge Amount : </b>&#8377;" . $dir->charge_amount; ?>
                                                </p>
                                                <p><i class="fa fa-map-marker"> </i>
                                                    <?php echo "<b>Holder Address : </b>" . $dir->charge_address; ?>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
